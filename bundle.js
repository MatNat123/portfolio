...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/MatNat123', responseHandler1)
...
function portfolioComponent ({ data = {}, theme = {} } = {}) {
  ...
  function openNewTab() {
    var url = "https://matnat123.github.io/quiz/"
...
function footerComponent ({ data = {}, theme = {} } = {}) {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/MatNat123">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
        <a href="mailto:rikalovic.natasa@gmail.com ">
